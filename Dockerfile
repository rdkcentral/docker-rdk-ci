...
RUN apt-get update && apt-get install -y build-essential \
          ...
          libc6-dev libdbus-glib-1-dev libevent-dev libjsoncpp-dev libmnl-dev libnanomsg-dev libpcap-dev libupnp-dev libxml2-utils libev-dev libsnmp-dev libqmi-glib-dev \
 && apt-get clean \
